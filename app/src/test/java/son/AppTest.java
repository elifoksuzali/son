...
class AppTest {
    ...
    @Test
    public void testNotEqualsArray(){ //ArrayList<Integer> array = new ArrayList<>(); //fonksiyon uygulanacak array
        ArrayList<Integer> array1 = new ArrayList<>(Arrays.asList(1,1)); //esit mi sorulacak array
    ...
    @Test
    public void testNull(){//App.Hesapla();
        assertNotNull(array); }
     //ayni array oldugunu iddia etme testi
     @Test
     public void testSameArray(){
         assertSame(App.Hesapla(array, 1,1 ,1), App.Hesapla(array, 1,1,1));}
